...
<div class="jumbotron jumbotron-fluid">
  <div class="container text-left">
    <h1 class="display-4">Muscle</h1>
    <hr class="my-4">
    <p class="lead">
    	DietHouseSemarang menawarkan berbagai makanan lezat untuk disantap selagi Anda berolahraga untuk membentuk otot anda. Bukan hanya leza, Kami juga memperhatikan berbagai nutrisi yang dibutuhkan untuk membentuk otot anda yang diawasi oleh tim ahli gizi profesional. Anda tak perlu kawatir mengenal kandungan protein, takaran karbohidrat dan berbagai zat penting yang terdapat di dalam santapan anda karena kamu sudah mengolahnya untuk anda. 
    </p>
    <br>
    <h2 class="display-4">CONTOH MENU</h2>
    <hr class="my-4">
    <!-- THUMBNAIL -->
	  <br><br>
	    	<div class="row">
	    		<div class="col-sm-4">
	    			<div class="card" style="width: 18rem; height: 600px">
					  <img src="../asset/img/food/tempe.jpg" class="card-img-top" alt="...">
					  <div class="card-body">
					    <p class="card-text text-dark text-left">Olahan tempe yang tinggi protein dan kalsium, dipadukan dengan jagung manis yang dibungkus dalam balutan tortilla. Menu sederhana yang lezat untuk menemani waktu makan anda.
	    		...
	    		<div class="col-sm-4">
	    			<div class="card" style="width: 18rem; height: 600px;">
					  <img src="../asset/img/food/shirataki.jpg" class="card-img-top" alt="...">
					  <div class="card-body">
					    <p class="card-text text-dark text-left">Kenikmatan shirataki dengan mie shirataki yang rendah kalori
					    <p style="font-size: 14px;" class="text-dark text-left">Rp. 50.000</p>
					    <br>
					    <br>
					    <br>
...
<br><br><br>
 <!-- ahir cara pesan -->
	...
	<script type="text/javascript">
		function notif(){
			alert('Anda yakin ingin keluar system?');
		}
	</script>
