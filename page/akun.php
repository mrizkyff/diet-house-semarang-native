...
<div class="jumbotron jumbotron-fluid">
  <div class="container text-left" style="background-color: lightgray; width: 550px; height: 400px; border-radius: 10px;">
  	<?php 
  	if(isset($_GET['pesan'])){
  		...
  		if($pesan == 'sukses'){
  			?>
  			<div class="alert alert-success" role="alert" style="width: 100%;"><b>Register Berhasil!</b>Silahkan Login.</div>
  			<?php		
  		}
  		else{
  			?>
  			<div class="alert alert-danger" role="alert" style="width: 100%;"><b>Username Salah!</b> Periksa kembali username dan password.</div>
  			<?php
  		}
  	}
  	 ?>
		...
		<form action="../login.php" method="post">
			...
			<button class="btn btn-success" type="button" data-toggle="modal" data-target="#register">Register</button>
			<a href="#" style="float: right;"><u>Lupa Password</u></a>
		</form>
  </div>
</div>
<br><br>
