...
<div class="jumbotron jumbotron-fluid">
  <div class="container text-left">
    <h1 class="display-4">Cara Pemesanan</h1>
    <h5 class="text-left">1. Log in/Register</h5>
    <p>Pertama kali yang dilakukan oleh pembeli adalah login, jika pembeli tidak mempunyai akun maka pembeli harus registrasi terlebih dahulu untuk bisa melihat dan memesan menu yang kami sajikan.</p>
    <h5 class="text-left">2.Pilih Menu Paket</h5>
    <p>Pembeli jika sudah melakukan login atau regristrasi, pembbeli dapat memilih menu paket yang sudah kami sediakan atau dapat memilih menu yang dibutuhkan.</p>
    <h5 class="text-left">3.Lengkapi Pemesanan</h5>
    <p>Pembeli harus melemngkapi data data dan pemesanan yang benar.</p>
    <h5 class="text-left">4.Pembayaran</h5>
    <p>Pembeli dapat melakukan transaksi dengan cara cod atau transfer.</p>
    <h5 class="text-left">5.Tunggu Pesanan Datang</h5>
    <p>Pesanan akan segera diantar sesuai dengan hari dan tanggal yang disesuaikan. </p>
  </div>
</div>
<br><br>
 <!-- ahir cara pesan -->
